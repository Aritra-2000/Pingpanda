...
export const DashboardEmptyState = () =>{
    ...
    return <Card className="flex flex-col items-center justify-center rounded-2xl flex-1 text-center p-6">
        <div className="flex justify-center w-full pt-8">
         <img src="/brand-asset-wave.png" alt="No categories" className="size-48 -mt-24"/>
        </div>

        <h1 className="m-2 text-xl-8 font-medium tracking-tight text-gray-900">No Event Categories Yet</h1>

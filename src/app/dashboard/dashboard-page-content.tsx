...
import { ArrowRight, BarChart2, Clock, DatabaseIcon, Trash2 } from "lucide-react"
...
export const DashboardPageContent = () =>{
    ...
    if(isEventCategoriesLoading){
        return <div className="flex flex-1 justify-center items-center h-full w-full">
            <LoadingSpinner/>
        </div>
    }
                  ...
                  <div className="relative p-6 z-10">
                      <div className="flex items-center gap-4 mb-6">
                         <div className="size-12 rounded-full " style={
                            {background : category.color ? `#${category.color.toString(16).padStart(6,"0")}`: "#f3f4f6"}
                         }/>
                         <div>
                      ...
                      <div className="flex items-center justify-between mt-4">
                        <Link href={`/dashboard/category/${category.name}`} className={buttonVariants({variant: "outline", size:"sm", className:"flex items-center gap-2 text-sm"})}> 
        ...
        >
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-sm/6 text-gray-600">
                      Are you sure you want to delete the category "{deletingCategory}"?This action cantnot be undone
                    </p>
                </div>

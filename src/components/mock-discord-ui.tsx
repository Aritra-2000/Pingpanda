...
import { Cog, Gift, Headphones, HelpCircle, Inbox, Menu, Mic, Phone, PlusCircle, Search, Smile, Sticker, UserCircle, UserCircleIcon, Video } from "lucide-react";
    ...
    return (
        <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-gray text-white rounded-lg overflow-hidden shadow-xl">
            <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
                ...
                {[...Array(5)].map((_, i) => (
                    <div key={i}
                        className="size-12 bg-discord-gray rounded-3xl flex 
                          items-center justify-center mb-3 hover:rounded-xl 
                          transition-all duration-200 hover:bg-discord-brand-color 
                          cursor-not-allowed"
                    >
                ...
                <div
                    className="group mt-auto size-12 bg-discord-gray rounded-3xl flex 
                          items-center justify-center mb-3 hover:rounded-xl 
                          transition-all duration-200 hover:bg-[#3ba55c] 
                          cursor-not-allowed"
                >
                ...
                <div className="flex-1 overflow-y-auto pt-4">
                    ...
                    <div className="px-2 mb-4">
                        ...
                        <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
                            <Image src="/brand-asset-profile-picture.png" alt="PingPanda Avatar" className="object-cover rounded-full mr-3" width={32} height={32} />
            ...
            <div className="flex-1 flex flex-col">
                <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
                    ...
                    <div className="flex items-center">
                        <div className="relative">
                            <Image src="/brand-asset-profile-picture.png" alt="Pingpanda Avatar" width={40} height={40} className="object-cover rounded-full mr-3" />
                ...
                {/*message*/}
                <div className="flex-1 overflow-y-auto p-4bg-discord-backgrouvd flex flex-col-reverse">
                    {children}
                </div>
                {/* message input */}
                <div className="p-4">
                    <div className="flex place-items-center bg-[#40444b] rounded-lg p-1">
                        <PlusCircle className="mx-3 text-[#b9bbbe]
                            hover:text-while cursor-not-allowed"/>
                        <input readOnly type="text" className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#72767d] focus: outline-none cursor-not-allowed" />
